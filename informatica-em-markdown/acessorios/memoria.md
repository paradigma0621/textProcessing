...
<p align="center">
  <img src="https://commons.wikimedia.org/wiki/Special:FilePath/KL_CoreMemory.jpg?width=420" alt="Memória de núcleo magnético" width="420"><br>
...
> ⭐ **Curiosidade:** é dessa era que vem a expressão **"core dump"** (despejo de memória) — o "core" se refere literalmente aos **núcleos de ferrite**. O termo sobreviveu décadas após a tecnologia desaparecer.
...
> 🔗 **Veja também:** [`../geral/memoria.md`](../geral/memoria.md) · [`../computadores/IBM-PC.md`](../computadores/IBM-PC.md) · [`../computadores/arquitetura.md`](../computadores/arquitetura.md)
